...
namespace LogicPad2.Diagram
{
    ...
    public class CircuitXML
    {
        ...
        /// <param name="path"></param>
        /// <param name="gc"></param>
        public void Save(string path, GateInkCanvas gc)
        {
            XElement root = new XElement("CircuitGroup");
            root.SetAttributeValue("Version", "1.2");
        ...
        public Gates.AbstractGate CreateGate(XElement gate)
        {
        ...
        public Gates.Terminal CreateTerminal(Dictionary<int, Gates.AbstractGate> gid, XElement terminal)
        {
